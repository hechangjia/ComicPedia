...
export const QUALITY_PRESETS: Record<GenerationQuality, QualityPreset> = {
  ...
  standard: {
    label: "标准",
    icon: "⭐",
    desc: "默认推荐，保留事实约束，减少前置等待",
    timeHint: "约40-90秒",
    agents: ["准确性研究（科普/百科）", "脚本校验", "自动修复"],
    maxTokens: 4000,
    inferenceSteps: 30,
    promptHint: "用适中的细节描述场景和对话，确保叙事完整，并主动拉开场景与镜头变化",
  },
  fine: {
    label: "精细",
    icon: "💎",
    desc: "AI 全流程审核",
    timeHint: "约3-5分钟",
    agents: ["主题研究", "Wikipedia", "准确性研究", "叙事大纲", "脚本校验", "自动修复", "VLM 视觉评审", "自动修图"],
    maxTokens: 8000,
    inferenceSteps: 50,
