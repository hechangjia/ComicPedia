...
export const STYLE_META: Record<ComicStyle, StyleMeta> = {
  flat: {
    ...
    negativePrompt: "photorealistic, 3D render, gradient shadows, complex textures, hand-drawn, sketch lines, dark background",
  },
  anime: {
    label: "日系动漫",
    desc: "大眼睛，赛璐璐着色",
    ...
    negativePrompt: "photorealistic, western cartoon, 3D render, blurry, low quality, deformed, dull colors",
  },
  cartoon: {
    label: "欧美卡通",
    desc: "粗线条，夸张表情",
    ...
    negativePrompt: "anime, photorealistic, 3D render, sketch, watercolor, blurry, muted colors",
  },
  chibi: {
    label: "Q版可爱",
    desc: "头大身小，盲盒质感",
    ...
    negativePrompt: "realistic proportions, scary, horror, dark colors, sharp edges, photorealistic, complex background",
  },
  manga: {
    label: "日漫线稿",
    desc: "黑白分明，速度线",
    ...
    negativePrompt: "color, watercolor, photorealistic, 3D, gradient, soft shading, pastel",
  },
  realistic: {
    label: "写实风格",
    desc: "概念艺术，电影质感",
    ...
    negativePrompt: "cartoon, anime, chibi, flat colors, low quality, blurry, deformed hands, extra fingers, oversaturated",
  },
  watercolor: {
    label: "水彩风格",
    desc: "湿画法，颜料晕染",
    ...
    negativePrompt: "digital art, sharp hard lines, flat solid colors, 3D render, photorealistic, hard edges, neon colors",
  },
  sketch: {
    label: "黑白素描",
    desc: "铅笔交叉线，纸张质感",
    ...
    negativePrompt: "color, digital art, 3D render, photorealistic, clean vector lines, gradients",
  },
  inkwash: {
    label: "水墨风格",
    desc: "写意笔触，留白意境",
    ...
    negativePrompt: "western art style, digital art, 3D render, bright saturated colors, photorealistic, hard mechanical edges, neon",
  },
  pixel: {
    label: "像素风格",
    desc: "复古游戏，16色限制",
    ...
    negativePrompt: "smooth gradients, photorealistic, high resolution detail, anti-aliasing, 3D render, blurry, modern art",
  },
  infographic: {
    label: "手绘信息图",
    desc: "涂鸦图标，知识可视化",
